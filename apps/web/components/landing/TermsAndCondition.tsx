          ...
          <div className="divide-gray--200 -my-9 divide-y">
            <div className="py-9">
              ...
              <p className="mt-3 text-base text-gray-600">
                Welcome to Timehuddle, Inc. (“Company”, “we”, “our”, “us”)! As you have just clicked our Terms
                of Service, please pause, grab a cup of coffee and carefully read the following pages. It will
                take you approximately 20 minutes
              </p>
              <p className="mt-3 text-base text-gray-600">
                These Terms of Service (“Terms”, “Terms of Service”) govern your use of our web pages located
                at https://timehuddle.com operated by Timehuddle.
              </p>
              <p className="mt-3 text-base text-gray-600">
                Our Privacy Policy also governs your use of our Service and explains how we collect, safeguard
                and disclose information that results from your use of our web pages. Please read it here
                https://timehuddle.com/privacy.
              </p>
              <p className="mt-3 text-base text-gray-600">
              ...
              <p className="mt-3 text-base text-gray-600">
                ...
                but please let us know by emailing at support@timehuddle.com so we can try to find a solution.
                These Terms apply to all visitors, users and others who wish to access or use Service.
              </p>
              <p className="mt-3 text-base text-gray-600">Thank you for being responsible.</p>
            </div>

            <div className="py-9">
              <p className="text-xl font-semibold text-black">Communications</p>
              <p className="mt-3 text-base text-gray-600">
            ...
            <div className="py-9">
              <p className="text-xl font-semibold text-black">Purchases</p>
              <p className="mt-3 text-base text-gray-600">
            ...
            <div className="py-9">
              <p className="text-xl font-semibold text-black">Contests, Sweepstakes and Promotions</p>
              <p className="mt-3 text-base text-gray-600">
            ...
            <div className="py-9">
              <p className="text-xl font-semibold text-black">Subscriptions</p>
              <p className="mt-3 text-base text-gray-600">
              ...
              <p className="mt-3 text-base text-gray-600">
                ...
                same conditions unless you cancel it or timehuddle.com, Inc. cancels it. You may cancel your
                Subscription renewal either through your online account management page or by contacting
                timehuddle.com, Inc. customer support team.
              </p>
              <p className="mt-3 text-base text-gray-600">
                A valid payment method, including credit card or PayPal, is required to process the payment
                for your subscription. You shall provide timehuddle.com, Inc. with accurate and complete
                ...
                authorize timehuddle.com, Inc. to charge all Subscription fees incurred through your account
                to any such payment instruments.
              </p>
              <p className="mt-3 text-base text-gray-600">
                Should automatic billing fail to occur for any reason, Meet Technologies Inc. will issue an
                electronic invoice indicating that you must proceed manually, within a certain deadline date,
                with the full payment corresponding to the billing period as indicated on the invoice.
              </p>
            </div>

            <div className="py-9">
              <p className="text-xl font-semibold text-black">Free Trial</p>
              <p className="mt-3 text-base text-gray-600">
                timehuddle.com, Inc. may, at its sole discretion, offer a Subscription with a free trial for a
              ...
              <p className="mt-3 text-base text-gray-600">
                ...
                charged by timehuddle.com, Inc. until Free Trial has expired. On the last day of Free Trial
              ...
              <p className="mt-3 text-base text-gray-600">
                At any time and without notice, timehuddle.com, Inc. reserves the right to (i) modify Terms of
                Service of Free Trial offer, or (ii) cancel such Free Trial offer.
              </p>
            </div>

            <div className="py-9">
              <p className="text-xl font-semibold text-black">Fee Changes</p>
              <p className="mt-3 text-base text-gray-600">
                timehuddle.com, Inc., in its sole discretion and at any time, may modify Subscription fees for
                the Subscriptions. Any Subscription fee change will become effective at the end of the
                then-current Billing Cycle.
              </p>
              <p className="mt-3 text-base text-gray-600">
                timehuddle.com, Inc. will provide you with a reasonable prior notice of any change in
            ...
            <div className="py-9">
              <p className="text-xl font-semibold text-black">Refunds</p>
              <p className="mt-3 text-base text-gray-600">
            ...
            <div className="py-9">
              ...
              <p className="mt-3 text-base text-gray-600">
                timehuddle.com, Inc. has the right but not the obligation to monitor and edit all Content
                provided by users. In addition, Content found on or through this Service are the property of
                timehuddle.com, Inc. or used with permission. You may not distribute, modify, transmit, reuse,
            ...
            <div className="py-9">
              <p className="text-xl font-semibold text-black">Prohibited Uses</p>
              <p className="mt-3 text-base text-gray-600">
            ...
            <div className="py-9">
              <p className="text-xl font-semibold text-black">No Use By Minors</p>
              <p className="mt-3 text-base text-gray-600">
                Service is intended only for access and use by individuals at least eighteen (18) years old.
                By accessing or using any of Company, you warrant and represent that you are at least eighteen
                (18) years of age and with the full authority, right, and capacity to enter into this
            ...
            <div className="py-9">
              <p className="text-xl font-semibold text-black">Accounts</p>
              <p className="mt-3 text-base text-gray-600">
            ...
            <div className="py-9">
              <p className="text-xl font-semibold text-black">Intellectual Property</p>
              <p className="mt-3 text-base text-gray-600">
                Service and its original content (excluding Content provided by users), features and
                functionality are and will remain the exclusive property of timehuddle.com, Inc. and its
                licensors. Service is protected by copyright, trademark, and other laws of foreign countries.
                Our trademarks and trade dress may not be used in connection with any product or service
                without the prior written consent of timehuddle.com, Inc..
              </p>
            </div>

            <div className="py-9">
              <p className="text-xl font-semibold text-black">Copyright Policy</p>
              <p className="mt-3 text-base text-gray-600">
              ...
              <p className="mt-3 text-base text-gray-600">
                ...
                submit your claim via email to dmca@timehuddle.com, with the subject line: “Copyright
            ...
            <div className="py-9">
              <p className="text-xl font-semibold text-black">Error Reporting & Feedback</p>
              <p className="mt-3 text-base text-gray-600">
                You may provide us either directly at support@timehuddle.com or via third party sites and
            ...
            <div className="py-9">
              <p className="text-xl font-semibold text-black">Disclaimer of Warranty</p>
              <p className="mt-3 text-base text-gray-600">
            ...
            <div className="py-9">
              <p className="text-xl font-semibold text-black">Limitation of Liability</p>
              <p className="mt-3 text-base text-gray-600">
            ...
            <div className="py-9">
              <p className="text-xl font-semibold text-black">Termination</p>
              <p className="mt-3 text-base text-gray-600">
            ...
            <div className="py-9">
              <p className="text-xl font-semibold text-black">Governing Law</p>
              <p className="mt-3 text-base text-gray-600">
            ...
            <div className="py-9">
              <p className="text-xl font-semibold text-black">Changes To Service</p>
              <p className="mt-3 text-base text-gray-600">
            ...
            <div className="py-9">
              <p className="text-xl font-semibold text-black">Amendments To Terms</p>
              <p className="mt-3 text-base text-gray-600">
            ...
            <div className="py-9">
              <p className="text-xl font-semibold text-black">Waiver And Severability</p>
              <p className="mt-3 text-base text-gray-600">
            ...
            <div className="py-9">
              <p className="text-xl font-semibold text-black">Acknowledgement</p>
              <p className="mt-3 text-base text-gray-600">
