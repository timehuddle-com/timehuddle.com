...
async function getHandler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (checkoutSession.payment_status === "paid" && stripeCustomer.metadata.username) {
    try {
      ...
      return {
        message:
          "We have received your payment. Your premium username could still not be reserved. Please contact support@timehuddle.com and mention your premium username",
      };
    }
  }
